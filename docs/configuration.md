...
unnoticed, `trigger_probe_interval_s` how long a broken *trigger* path could, and
`proof_interval_s` how often the hardware path is proven by actually cutting
drive. See [safety.md](safety.md).
